...
export type mat2 = [number, number, number, number] | IndexedCollection;
export type Mat2 = mat2;
export type ReadonlyMat2 = readonly [number, number, number, number] | IndexedCollection;
...
export function LDU(L: mat2, D: mat2, U: mat2, a: ReadonlyMat2): [mat2, mat2, mat2] {
  L[2] = a[2] / a[0];
  U[0] = a[0];
  U[1] = a[1];
  U[3] = a[3] - L[2] * U[1];
