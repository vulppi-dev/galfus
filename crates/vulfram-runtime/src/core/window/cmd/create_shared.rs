...
mod tests {
    ...
    fn register_window_realm_creates_3d_realm_with_surface_and_default_graph() {
        ...
        assert!(
            engine
                ...
                .entries
                .values()
                .any(|entry| entry.value.window_id == window_id && entry.value.surface == surface_id),
    ...
    fn realm3d_element_states_are_created_with_expected_values() {
        use crate::core::resources::{
            ...
            CmdModelCreateArgs, CmdResultCameraCreate, CmdResultLightCreate, CmdResultMaterialCreate,
            CmdResultModelCreate, LightKind, MaterialKind, ShaderMaterialPreset,
        };
        ...
        let material_res: CmdResultMaterialCreate = crate::core::resources::engine_cmd_material_create(
            &mut engine,
