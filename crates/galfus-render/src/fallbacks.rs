...
pub fn create_fallback_textures(device: &wgpu::Device, queue: &wgpu::Queue) -> FallbackTextures {
    ...
    let fallback_shadow_view = fallback_shadow_texture.create_view(&wgpu::TextureViewDescriptor {
