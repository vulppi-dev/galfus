...
pub fn graph_is_compatible_with_realm_kind(plan: &RenderGraphPlan, realm_kind: RealmKind) -> bool {
    ...
    match realm_kind {
        RealmKind::ThreeD => galfus_realm_3d::graph_is_compatible(pass_ids),
        RealmKind::TwoD => galfus_realm_2d::graph_is_compatible(pass_ids),
    }
}
...
pub fn supports_render_pass_for_realm_kind(pass_id: &str, realm_kind: RealmKind) -> bool {
    match realm_kind {
        RealmKind::ThreeD => galfus_realm_3d::supports_render_pass(pass_id),
        RealmKind::TwoD => galfus_realm_2d::supports_render_pass(pass_id),
    }
}
