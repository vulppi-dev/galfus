mod bootstrap;
extern crate self as galfus_runtime;
...
pub use core::{
    galfus_dispose, galfus_get_profiling, galfus_init, galfus_receive_events, galfus_receive_queue,
    galfus_send_queue, galfus_tick, galfus_upload_buffer,
};
