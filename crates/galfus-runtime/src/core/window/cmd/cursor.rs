...
use galfus_platform::{PlatformCursorGrabMode, plan_browser_cursor_mode_change};
#[cfg(not(target_arch = "wasm32"))]
pub use galfus_protocol::CursorIcon;
pub use galfus_protocol::{CmdResultWindowCursor, CmdWindowCursorArgs, CursorGrabMode};
