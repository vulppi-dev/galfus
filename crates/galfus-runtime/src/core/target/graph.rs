...
pub use galfus_realm_core::{RenderInvocation, TargetEdge, TargetGraphDiff, TargetGraphPlan};
...
impl TargetGraphPlanner {
    pub fn build_plan(
        ...
        galfus_realm_core::TargetGraphPlanner.build_plan(
            &target_semantics,
            target_dependencies,
            layers,
            &realm_ids,
...
pub fn collect_render_invocations(
    ...
    for target_id in target_order {
        ...
        for layer in target_layers {
            let resolved = galfus_render::resolve_auto_graph_layout(target_size, &layer.layout);
