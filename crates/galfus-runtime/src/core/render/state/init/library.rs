...
impl RenderState {
    pub(crate) fn init_layouts(&self, device: &wgpu::Device) -> galfus_render::Layouts {
        let sizes = galfus_render::RenderLayoutSizes {
        ...
        galfus_render::create_render_layouts(device, &sizes)
    }
}
